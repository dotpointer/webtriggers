...
switch ($action) {
  case 'trigger':
?>
  <p>Queued action <?php echo $actions[$action_index]['name'] ?>.</p>
<?php
    break;
}
?>
...
?>
    ...
    <br>
    <table>
      <caption>Queue - latest <?php echo count($queue) ?></caption>
      <thead>
        <tr class="header">
            <th>Name</th>
            <th>Status</th>
            <th class="extra">Created</th>
            <th class="extra">Started</th>
            <th class="extra">Ended</th>
        </tr>
      </thead>
      <tbody>
<?php
